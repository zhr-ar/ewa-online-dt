...
class DecisionTransformer(TrajectoryModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.transformer = GPT2Model(config, variant=variant)
    ...
    def forward(
        ...
        self.transformer.rewards = rewards  # EWA Store rewards in transformer instance
        self.transformer.actions = actions  # EWA Store actions in transformer instance
        # print("**** forward in DecisionTransformer")
        ...
        # print("**** forward in DecisionTransformer-return predictions")
    ...
    def get_predictions(
        ...
        # print("**** get_predictions in DecisionTransformer")
        state_preds, action_preds, return_preds = self.forward(
            states,
            actions,
            rewards, # This is where rewards first enter the system
            # None,
            returns_to_go,
            timesteps,
            ordering,
