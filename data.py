...
def create_dataloader(
    ...
    reward_scale,
    action_range,
    num_workers=4, ## zahra # it was originally 24, but I changed it to 4
):
    # total number of sub-trajectories you need to sample
    sample_size = batch_size * num_iters
    print("**** total number of sub-trajectories you need to sample: ", sample_size)
    print(f"**** sample_size {sample_size} = batch_size {batch_size} * num_iters {num_iters}")
